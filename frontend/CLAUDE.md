...
**核心页面** (6个): /, /articles, /podcasts, /tweets, /videos, /featured
**详情页面**: /resources/[id]
...
- ✅ 删除 components/FeaturedSignals.tsx 和 FeaturedSignalCard.tsx
- ✅ 删除 next.config.js 中的 signals rewrite 规则
- ✅ 统一使用 resources 作为唯一内容模型
- ✅ GEB 文档同步更新

### 2025-01-10 - 系统优化（页面性能 + 精选页面）
- ✅ 页面性能优化: 删除 PageTransition 包装（消除延迟）
