...
export function DotGrid({
  ...
  useEffect(() => {
    ...
    const win = window as Window & { ResizeObserver?: { new(callback: ResizeObserverCallback): ResizeObserver } }
  ...
  return (
    <section className={`p-4 flex items-center justify-center h-full w-full relative ${className}`}>
