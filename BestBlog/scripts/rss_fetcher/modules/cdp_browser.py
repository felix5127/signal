...
class CDPBrowserManager:
    ...
    async def launch_and_connect(
        ...
        try:
            ...
            print(f"[CDPBrowserManager] CDP浏览器启动失败: {e}")
            await self.cleanup()
            raise
    ...
    async def _get_browser_path(self) -> str:
        ...
        print(f"[CDPBrowserManager] 浏览器路径: {browser_path}")
    ...
    async def _test_cdp_connection(self, debug_port: int) -> bool:
        ...
        try:
            ...
            print(f"[CDPBrowserManager] CDP连接测试失败: {e}")
            return False
    ...
    async def _launch_browser(self, browser_path: str, headless: bool):
        ...
        if config.SAVE_LOGIN_STATE:
            ...
            print(f"[CDPBrowserManager] 用户数据目录: {user_data_dir}")
    ...
    async def _get_browser_websocket_url(self, debug_port: int) -> str:
        ...
        try:
            ...
            print(f"[CDPBrowserManager] 获取WebSocket URL失败: {e}")
            raise
    ...
    async def _connect_via_cdp(self, playwright: Playwright):
        ...
        try:
            ...
            print(f"[CDPBrowserManager] CDP连接失败: {e}")
            raise
    ...
    async def _create_browser_context(
        ...
        if contexts:
            ...
            print("[CDPBrowserManager] 使用现有的浏览器上下文")
        else:
            # 创建新的上下文
            context_options = {
            ...
            if user_agent:
                ...
                print(f"[CDPBrowserManager] 设置用户代理: {user_agent}")
            ...
            print("[CDPBrowserManager] 创建新的浏览器上下文")
    ...
    async def add_stealth_script(self, script_path: str = "libs/stealth.min.js"):
        ...
        if self.browser_context and os.path.exists(script_path):
            try:
                ...
                print(f"[CDPBrowserManager] 添加反检测脚本失败: {e}")
    ...
    async def add_cookies(self, cookies: list):
        ...
        if self.browser_context:
            try:
                ...
                print(f"[CDPBrowserManager] 已添加 {len(cookies)} 个Cookie")
            except Exception as e:
                print(f"[CDPBrowserManager] 添加Cookie失败: {e}")
    ...
    async def get_cookies(self) -> list:
        ...
        if self.browser_context:
            try:
                ...
                print(f"[CDPBrowserManager] 获取Cookie失败: {e}")
                return []
        return []
        ...
        try:
            ...
            if self.browser_context:
                try:
                    ...
                    print("[CDPBrowserManager] 浏览器上下文已关闭")
            ...
            if self.browser:
                try:
                    ...
                    print("[CDPBrowserManager] 浏览器连接已断开")
            ...
            print(f"[CDPBrowserManager] 清理资源时出错: {e}")
    ...
    async def get_browser_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"[CDPBrowserManager] 获取浏览器信息失败: {e}")
            return {}
